...
const fr: Translations = {
  ...
  Home: {
    ...
    job: "Développeur de sites Web et d'applications mobiles",
    currentWork :"Travail actuel",
    lastWork: "Travaillé précédemment sur",
    learning  :"Apprentissage actuel",
    colaborating: "Collaboration actuelle avec",
    currentProjectName :"Application Mushaf",
